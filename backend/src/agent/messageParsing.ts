...
export function isAdmissionsRelated(message: string) {
  const value = normalize(message);
  return ["hola", "gracias", "programa", "carrera", "pregrado", "posgrado", "maestria", "especializacion", "doctorado", "admis", "asesor", "persona", "humano", "cohorte", "turma", "requisito", "fecha", "costo", "cuesta", "valor", "beca", "financi", "inscrip", "matricul", "pago", "aspirante", "universidad", "uniandes", "sistemas", "diseno", "ingenieria", "derecho", "medicina", "economia", "arquitectura", "psicologia", "program", "career", "undergraduate", "graduate", "master", "cohort", "requirement", "date", "cost", "admissions", "advisor", "agent", "human", "design", "engineering", "medicine", "course", "requirements", "quero", "curso", "informacoes", "datas", "custos", "pagamento", "assessor", "atendente", "contact", "correo", "email", "whatsapp", "llamada", "call", "ligacao", "autoriz", "authorize", "confirm", "correg", "correct", "avisar", "notify", "interes", "interest", "simular falla", "reintent", "try again", "intentar de nuevo"].some((term) => value.includes(term));
}
