...
export interface ProgramCard { id: string; name: string; cohortOpen: boolean | null; period: string | null; deadline: string | null; requirements: string[] | null; applicationSteps: string[] | null; enrollmentSteps: string[] | null; studyStartSteps: string[] | null; costCop: number | null; source: string; status: string; }
