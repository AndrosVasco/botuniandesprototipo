...
const programId = { type: "string" } as const;
...
export const openAITools: OpenAI.Chat.Completions.ChatCompletionTool[] = [
  ...
  { type: "function", function: { name: "checkAdvisorAvailability", description: "Check simulated Admissions advisor availability by interface mode.", parameters: { type: "object", properties: { mode: { type: "string", enum: ["demo", "ai"] } }, required: ["mode"] } } },
